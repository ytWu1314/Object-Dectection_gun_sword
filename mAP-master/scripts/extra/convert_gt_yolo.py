...
for tmp_file in txt_list:
  ...
  for fname in os.listdir('C:/Users/PC_SKY_WYT/Desktop/mixEd/DeepLearning/Deeplearning_Sources/Code/mAP-master/input/images-optional'):
    if fname.startswith(image_name):
      ## image found
      #print(fname)
      img = cv2.imread('C:/Users/PC_SKY_WYT/Desktop/mixEd/DeepLearning/Deeplearning_Sources/Code/mAP-master/input/images-optional/' + fname)
